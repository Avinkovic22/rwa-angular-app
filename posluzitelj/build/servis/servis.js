...
function pripremiPutanjeAplikacija() {
    let restApp = new RestApp(konfiguracija.dajKonfiguraciju().jwtTajniKljuc, konfiguracija.dajKonfiguraciju().tmdbApiKeyV3, konfiguracija.dajKonfiguraciju().jwtValjanost);
...
function pripremiPutanjeResursTMDB() {
    let restTMDB = new RestTMDB(konfiguracija.dajKonfiguraciju()["tmdbApiKeyV3"], konfiguracija.dajKonfiguraciju()["jwtTajniKljuc"]);
