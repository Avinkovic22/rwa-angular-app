...
export class KorisnikDAO {
    ...
    dodaj(korisnik) {
        try {
            ...
            let rezultati = this.baza.dajPodatke(sqlProvjera, [korisnik.korime, korisnik.email]);
    ...
    async dajSve() {
        ...
        for (let p of podaci) {
            let k = { ime: p["ime"], prezime: p["prezime"], korime: p["korime"],
    ...
    azurirajPrava(korime, servis_prava) {
        try {
